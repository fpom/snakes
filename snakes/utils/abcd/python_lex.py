...
from snakes.utils.abcd import lex
from snakes.utils.abcd import python_tokens
...
class PythonLexer(object):
    ...
    def input(self, data, filename="<string>", add_endmarker=True):
        ...
        self.token_stream = make_token_stream(self.lexer, add_endmarker=add_endmarker)
